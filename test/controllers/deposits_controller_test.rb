...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { description: @deposit.description, value: @deposit.value } }, as: :json
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { description: @deposit.description, value: @deposit.value } }, as: :json
    assert_response 200
  end
